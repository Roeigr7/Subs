...
const TextContainer = styled.div((props) => [
  ...
  props.textOnLeft ? tw`lg:pl-12 lg:order-last` : tw`lg:pr-12 lg:order-first`,
]);
...
export default ({
  ...
  description = "Here are what some of our amazing customers are saying about our hotels & tours. יבש, כאנה ניצאחו נמרגי שהכים תוק, הדש שנרא התידם הכייר וק. הועניב היושבב שערש שמ",
  testimonials = null,
  textOnLeft = false,
}) => {
  /*
